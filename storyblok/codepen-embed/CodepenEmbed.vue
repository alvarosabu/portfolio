...
const codepenEmbed = ref<HTMLElement | null>(null)
...
watch(
  ...
  () => {
    ...
    if (codepenEmbed.value) { codepenEmbed.value.appendChild(codepenScript) }
  },
)
</script>
  ...
  <div ref="codepenEmbed" class="rounded overflow-hidden break-out-prose my-8">
    ...
    >
      <span>
        ...
        >@{{ blok.author }} </a>) on <a href="https://codepen.io">CodePen</a>.
      </span>
    </p>
  </div>
</template>
